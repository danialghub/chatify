...
import { ChatIcon, Modal } from "../index";
import { useAuthStore } from "../../store/useAuthStore";

const GroupInfoModal = memo(({ room, isOpen, onClose }) => {
            ...
            <div className="  flex items-center justify-center ">
                <div className="bg-white w-[400px] rounded-2xl overflow-hidden shadow-xl flex flex-col">
                    ...
                    <div className="bg-blue-700/80  text-white p-4 relative flex flex-col items-center">
                        <button className="absolute top-3 right-3 hover:bg-blue-700 p-2 rounded-full">
                            <Edit size={18} />
                        </button>
                        ...
                        <div className="flex items-center justify-center w-full gap-3 pt-4">
                            ...
                            <div className="flex justify-center py-1 border-b-2 bg-black/10  hover:bg-black/20 rounded-md flex-1 transition">
                                <button className="flex items-center gap-2  text-white font-medium px-4 py-2  ">
                                    <LogOut size={18} />
                                    ترک گروه
                                </button>
                            </div>
                    ...
                    {/* Content */}
                    <div className="flex-1 py-1 max-h-[50vh] overflow-y-auto text-black/50">
                        {activeTab === "members" ? (
